...
public class Q10 {
    ...
    private static String asciiCoversion(String text){
        ...
        String strUC1 = str1.toLowerCase();
        System.out.println("String 1 after converting into lowercase " + strUC1);
        asciiCoversion(str2);
        String strUC2 = str2;
        System.out.println("String 2 after converting into lowercase " + strUC2);



        System.out.println("Comparing both strings");
        if(strUC1.equals(strUC2.toLowerCase())){
